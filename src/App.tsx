...
const App: React.FC = () => {
  return (
    <div className="w-full max-w-[1200px] bg-[#202324] border border-[#373b3d] rounded flex flex-col overflow-hidden">
      {/* Header */}
      <Header />
      ...
      <div className="flex flex-1 gap-4 p-6 overflow-auto">
        {/* Left Panel - Charts */}
        <div className="flex flex-col gap-4 w-[571px] shrink-0">
          {/* Time Range Buttons */}
          <TimeRangeButtons />

          {/* MVexp Chart (Primary) */}
          <div className="bg-[#141415] rounded p-4 flex flex-col gap-4">
            <Chart
              title="MVexp"
              unit="l/min"
              maxValue="6"
          ...
          {/* Disclosure Area */}
          <div className="border-2 border-[#b39cf1] rounded p-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 pl-[104px]">
              {/* Time labels */}
              ...
              <div className="relative h-[20px] flex items-center">
                ...
                {/* Start handle */}
                <div className="absolute left-[20%] top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-5 bg-[#b39cf1] rounded-full cursor-ew-resize" />
                {/* End handle */}
                <div className="absolute right-[30%] top-1/2 translate-x-1/2 -translate-y-1/2 w-3 h-5 bg-[#b39cf1] rounded-sm cursor-ew-resize" />
              </div>
            </div>
        ...
        <div className="w-[274px] bg-[#141415] rounded p-4 shrink-0">
          <Readings />
        </div>
      </div>
    </div>
